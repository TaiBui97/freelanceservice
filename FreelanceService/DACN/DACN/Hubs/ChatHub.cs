...
namespace BasicChat
{
    ...
    public class ChatHub : Hub
    {
        ...
        public void AcceptNotification(int MaDDH)
        {
            ...
            db.SaveChanges();
            check = 2;
            foreach (var connectionId in _connections.GetConnections(buyerID.MaTaiKhoan.ToString()))
            {
        ...
        public void HoanThanhNotification(int MaDDH)
        {
            ...
            if (donhang.MaTaiKhoan == id)
            {
                ...
                foreach (var connectionId in _connections.GetConnections(sellerID.ToString()))
                {
            ...
            else
            {
                ...
                var sellerID = (from d in db.DonDatHangs
                                ...
                                select s.MaTaiKhoan).FirstOrDefault();
                foreach (var connectionId in _connections.GetConnections(donhang.MaTaiKhoan.ToString()))
                {
        ...
        public void CheckSeenNotification(string id)
        {
            ...
            {
                Clients.Client(connectionId).addNotification(dem,check);
            }
        }
